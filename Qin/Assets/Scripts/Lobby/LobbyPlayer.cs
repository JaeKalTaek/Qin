...
namespace Prototype.NetworkLobby
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        void SetupLocalPlayer()
        {
			...
			ChangeReadyButtonColor (NotReadyColor); //JoinColor);

			readyButton.transform.GetChild (0).GetComponent<Text> ().text = "Not Ready"; //"JOIN";
			...
			sideButton.onClick.AddListener(OnSideClicked);
        ...
        public override void OnClientReady(bool readyState)
        {
            if (readyState)
            {
                ...
                //readyButton.interactable = false;
				readyButton.onClick.RemoveAllListeners();
				readyButton.onClick.AddListener(OnUnReadyClicked);
            ...
            else
            {
                ...
                Text textComponent = readyButton.transform.GetChild(0).GetComponent<Text>();
				textComponent.text = "Not Ready"; //isLocalPlayer ? "JOIN" : "...";
		...
		public void OnMySide(bool newSide)
		{
			playerSide = newSide;
			sideButton.GetComponentInChildren<Text> ().text = newSide ? "Heroes" : "Qin";
		}
        ...
        {
			if(((LobbyPlayer)LobbyManager.s_Singleton.lobbySlots[0]).playerSide != ((LobbyPlayer)LobbyManager.s_Singleton.lobbySlots[1]).playerSide)
        ...
        public void ToggleReadyButton(bool enabled)
        {
			...
			waitingPlayers.SetActive(!enabled);
        }

        [ClientRpc]
        public void RpcUpdateCountdown(int countdown)
        {
			LobbyManager.s_Singleton.countdownPanel.GetComponentInChildren<Text>().text = "Match Starting in " + countdown;
